...
def flame_difference(label: str, object_name: str, r_type: str, r_type2: str, target_label: str) -> list:
    ...
    session = driver.session(database=normal)
...
def all_flame_difference_mean(label: str, object_list: list, r_type: str, r_type2: str, target_label: str) -> dict:
    ...
    for i in range(list_size):
        ...
        flame_dif_list = flame_difference(label, object_name, r_type, r_type2, target_label)
